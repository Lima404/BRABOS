...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      ...
      // ALTURAS AJUSTADAS PARA O BARBOS.
      // O padrao do shadcn e h-8 (32px). O barbeiro toca essa tela de pe, com
      // uma mao so e o dedo sujo de talco: o design-guide exige 44px minimo,
      // 48 ideal. Ver "Contexto de uso" em identidade/design-guide.md.
      size: {
        default:
          "h-11 gap-2 px-4 text-base has-data-[icon=inline-end]:pr-3 has-data-[icon=inline-start]:pl-3", // 44px — minimo
        lg: "h-12 gap-2 px-5 text-base has-data-[icon=inline-end]:pr-4 has-data-[icon=inline-start]:pl-4", // 48px — CTA principal
        icon: "size-11",
        "icon-lg": "size-12",
        // Abaixo de 44px: SO em area de mouse (painel desktop, barra de
        // ferramentas densa). Nunca em fluxo tocado durante o atendimento.
